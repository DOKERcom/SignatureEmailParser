...
namespace SignatureEmailParser.Models.SocialMediaMappingModels.VoilaNorbert
{
    public class EmailsFromUrlVoilaNorbertResponseModel
    {
        public bool Success { get; set; }
        public DataEmailsFromUrlVoilaNorbertModel Data { get; set; }
    }
    public class DataEmailsFromUrlVoilaNorbertModel
    {
        ...
        public List<EmailsDataEmailsFromUrlVoilaNorbertModel> Emails { get; set; }
        public DataEmailsFromUrlVoilaNorbertModel()
        {
            //Social = new List<SocialDataEmailsFromUrlSnovIOModel>();
            Emails = new List<EmailsDataEmailsFromUrlVoilaNorbertModel>();
    ...
    //}
    public class EmailsDataEmailsFromUrlVoilaNorbertModel
    {
